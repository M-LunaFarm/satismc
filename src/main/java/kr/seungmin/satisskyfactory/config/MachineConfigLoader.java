...
public final class MachineConfigLoader {
    public Map<String, MachineDefinition> load(FileConfiguration config) {
        ...
        for (String typeId : section.getKeys(false)) {
            ...
            Material placedMaterial = Material.matchMaterial(config.getString(path + "placed-block",
                    config.getString(path + "placed-material", "STONE")));
            if (placedMaterial == null) {
                placedMaterial = Material.STONE;
            }
            definitions.put(typeId, new MachineDefinition(
                    ...
                    MachineIndustry.fromConfig(config.getString(path + "industry", "")),
                    MachineRole.fromConfig(config.getString(path + "role", config.getString(path + "machine-role", ""))),
                    ...
                    ResourceNodeType.fromConfig(config.getString(path + "recipe-node-type", "")),
                    ...
                    ResourceNodeType.fromConfig(config.getString(path + "node-type", "")),
